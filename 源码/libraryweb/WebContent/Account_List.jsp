...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Account List</font></h2>
    ...
    <div class="row">
        ...
        <div class="input-group">
			...
			<form  action="SearchAccount_Name" method="post" >
				<input type="text" name="name" class="form-control" required placeholder="Name"">
				<span class="input-group-btn">
				<input name="submit" type="submit" value="Search" class="btn btn-primary">
				</span>
			</form>
			<form  action="SearchAccount_ID" method="post" >
	...
	<caption><font size="5">Administrator Account</font></caption>	
	<thead>
		<tr>
			<th>UserID</th>
			<th>Rights</th>
	...
	%>
		<tr>
			...
			<input type="hidden" name="UserID" value="<%=rs.getString("UserID") %>">
			<td><input name="submit" type="submit" value="Delete" class="btn btn-primary"></td>
			</form>
		</tr>
	<%
