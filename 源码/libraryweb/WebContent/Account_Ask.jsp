...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Management Account</font></h2>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
                ...
                <li class="active"><a href="Account_Ask.jsp">Account</a></li>
				...
				<li  class="active"><a href="Check_In.jsp">Check In</a></li>
        ...
        <div class="col-xs-9">
        <h3 align="center">
        <font face="Comic Sans MS">Ask For Authority</font>
        </h3>
        <p><font size="3">Please input you<b>UserID and Password</b>. If you
        are a super administrator, you can see and edit all users' information.
         However, if you are a normal administrator, you can only see and
         edit your own information.</font></p>
        <form class="login-form" action="loginAccount" method="post" align="center">
		<label>
