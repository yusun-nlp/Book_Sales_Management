...
<div class="container">
   <div class="jumbotron">
        <h1><font face="Comic Sans MS">Normal administrator</font></h1>
    </div>
    <div class="row">
        ...
        <div class="col-xs-9">
            ...
            <p>Your identity is the <span style="font-weight:bold">normal administrator</span>, who only has the limited rights on this system. On the left of the webpage is an navigation bar. If you want to realize some functions, you can <span style="font-weight:bold">click</span> on the relevant button. Pay attention that buttons with an arrow have a hidden menu, which require you to click on them if you want to see the hidden menu.</p>
            <p>The function of each button is as follows:</p>
            <hr>
            <h2 id="section-2">Account</h2>
            <p>In this section you can deal with <span style="font-weight:bold">only your own</span> information.</p>
            <p>If you want to use your authority, you have to input
            your UserID and Password again. After you get the authority,if needed, you can modify your own account information, including UserID, Password, name, gender, ID and age.</p>
            <hr>
            <h2 id="section-3">Book</h2>
            <p>In this section, you can deal with books in the store.</p>
            <h4>Book List:</h4>
            <p>You can check all books in the store, including IBSN, name, press, author, price and inventory.</p>
            <h4>Modify information:</h4>
            <p>You can modify the information of any book in the store in this past.</p>
            <hr>
