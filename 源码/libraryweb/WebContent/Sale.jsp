...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Book Sale</font></h2>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
				...
				<ul class="dropdown-menu">
				<li class="active"><a href="Sale.jsp">Sale Out</a></li>
        ...
        <div class="col-xs-9">
        <h3 align="center">
        <font face="Comic Sans MS">Search for ISBN</font>
        </h3>
        <p><font size="3">Please input the ISBN of the book that customers have bought. 
        If it exists, you need to input the sales amount. Otherwise, you will go to the 
        <b>Check In </b>webpage to decide whether you will purchase that kink of book.</font></p>
        <form class="login-form" action="SearchSale" method="post" align="center">
		<label>
