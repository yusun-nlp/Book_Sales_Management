...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Bill List</font></h2>
	...
	<caption><font size="5">Bill</font></caption>	
	<thead>
		<tr>
			<th>BillID</th>
			<th>Status</th>
	...
	<tbody>
  	<c:forEach items="${bill}" var="bill" varStatus="index">
		<tr>
			<td>${bill.billID}</td>
			<td>${bill.status}</td>
			<td>${bill.ISBN}</td>
