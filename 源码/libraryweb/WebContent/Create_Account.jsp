...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Create Account</font></h2>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
				...
				<li  class="active"><a href="Create_Account.jsp">Create Account</a></li>
				<li><a href="Account_List.jsp">Account List</a></li>
				</ul>
				</li>
        ...
        <form class="login-form" action="register" method="post" align="center"  onsubmit= "return formCheck() ">
		<label>
			<input type="text" name="UserID" required placeholder="UserID">
        </label>
        <div></div>
        <label>
        	<input type="password" id="pwd1" name="Password" required placeholder="Password">
        </label>
        <div></div>
        <label>
        	<input type="password" id="pwd2" name="Confrim_Password" required placeholder="Confirm_Password">
        </label>
        <div></div>
        <label>
			<input type="text" name="name" required placeholder="name">
        </label>
        <div class="hlyw-dx-main-c">
        	<input type="radio" class="hy-radio" ng-model="stateJX" value="male"  name="gender"> <font color="black">male</font>
        	<input type="radio" class="hy-radio"  ng-model="stateJX" value="female" name="gender"> <font color="black">female</font>
        </div>
        <label>
