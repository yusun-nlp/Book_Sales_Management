...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Order List</font></h2>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
				...
				<li class="active"><a href="Order_List.jsp">Order List</a></li>
				</ul>
				</li>
				<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown" href="#">
	...
	<caption><font size="5">Order Information</font></caption>
	<p></p>
	<thead>
		<tr>
			<th>OrderID</th>
