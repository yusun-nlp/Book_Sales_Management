...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Deal List</font></h2>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
				...
				<li class="active"><a href="Deal_List.jsp">Deal List</a></li>
				</ul>
				</li>
	...
	<caption><font size="5">Deal Information</font></caption>
	<p></p>
	<thead>
		<tr>
			<th>DealID</th>
