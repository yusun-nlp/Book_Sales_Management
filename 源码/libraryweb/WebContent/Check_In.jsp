...
<div class="container">
   <div class="jumbotron">
    ...
    <div class="row">
        ...
        <p><font size="3">Please input the ISBN of the book that you want to purchase. 
        If it exists, you can directly add it. Otherwise, you have to input
         all information of the book.</font></p>
        <form class="login-form" action="SearchISBN" method="post" align="center">
		<label>
