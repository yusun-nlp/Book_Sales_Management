...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Book List</font></h2>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
				...
				<li  class="active"><a href="Book_List.jsp">Book</a></li>
                <li class="dropdown">
        ...
        <div class="input-group">
			...
			<form  action="SearchBook_Name" method="post" >
				<input type="text" name="name" class="form-control" required placeholder="Name"">
				<span class="input-group-btn">
				<input name="submit" type="submit" value="Search" class="btn btn-primary">
				</span>
			</form>	
			<form  action="SearchBook_Press" method="post" >
				<input type="text" name="press" class="form-control" required placeholder="Press"">
				<span class="input-group-btn">
				<input name="submit" type="submit" value="Search" class="btn btn-primary">
				</span>
			</form>	
			<form  action="SearchBook_Author" method="post" >
	...
	<tbody>
  	<c:forEach items="${book}" var="book" varStatus="index">
		<tr>
			...
			<td><input name="submit" type="submit" value="Edit" class="btn btn-primary"></td>
		</tr>
		</form>
		</c:forEach>
	</tbody>
