...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Check in book</font></h2>
    ...
    <div class="row">
        ...
        <div class="col-xs-9">
        <h3 align="center"><font face="Comic Sans MS">New Book Information</font></h3>
        <br>
        <form class="login-form" action="CheckInNew" method="post" align="center">
		<label>
        ...
        <label>
   		...
   		<div></div>
   		<label>
			<input type="text" name="press" required placeholder="Press">
        </label>
   		<div></div>
   		<label>
   		...
   		<div></div>
   		<label>
			<input type="text" name="price" required placeholder="Retail_Price">
        </label>
   		<div></div>
        <label>
			<input type="text" name="prices" required placeholder="Prices">
        </label>
        <div></div>
        <label>
