...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Edit Book</font></h2>
    ...
    <div class="row">
        ...
        <h3 align="center"><font face="Comic Sans MS">Book Information</font></h3>
        <p><font size="3">If you want to edit the information, just change the corresponding input box, then click the "edit".</form></p>
        <br>
        <form class="login-form" action="UpdateBook" method="post" align="center">
		<c:forEach items="${bookinfo}" var="bookinfo" varStatus="index">
		<label>
			<input type="text" name="ISBN" value=${bookinfo.ISBN}>
        </label>
        <div></div>
		<label>
			<input type="text" name="name" value=${bookinfo.name}>
        </label>
        <div></div>
        <label>
			<input type="text" name="press" value=${bookinfo.press}>
        </label>
   		<div></div>
        <label>
        ...
        <div></div>
        <label>
			<input type="text" name="store" value=${bookinfo.store}>
        </label>
