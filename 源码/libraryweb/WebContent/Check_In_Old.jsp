...
<div class="container">
   <div class="jumbotron">
        <h2><font face="Comic Sans MS" size="10">Check In</font></h2>
	...
	<caption><font size="5">Book Information</font></caption>	
	<thead>
		<tr>
			<th>ISBN</th>
			<th>Name</th>
	...
	<tbody>
  	<c:forEach items="${book}" var="book" varStatus="index">
		<tr>
			<td>${book.ISBN}</td>
			<td>${book.name}</td>
			<td>${book.press}</td>
			<td>${book.author}</td>
			<td>${book.store}</td>
			<form action="CheckInOld" method="post" >
			<input type="hidden" name="ISBN" value="${book.ISBN}">
			<td><input class="form-control" type="text" name="amount" required placeholder="Amount"></td>
			<td><input class="form-control" type="text" name="prices" required placeholder="Prices"></td>
			
		</tr>
		</c:forEach>
	</tbody>
</table>
<input name="submit" type="submit" value="Purchase" class="btn btn-primary">
</form>
        </div>
    </div>
</div>
